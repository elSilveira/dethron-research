...
Atualiza��o: recupera��o por r�plicas verificadas dispon�vel na API do v2. Consulte REPLICAS.md para uso, valida��o e limites. As limita��es hist�ricas acima sobre rollback s�o mitigadas nessa API somente com um head externo confi�vel.
